...
// configuration step. It creates a namespace called `cmake_template_0`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_template_0::cmake::project_name, cmake_template_0::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_template_0::cmake::project_version);
      return EXIT_SUCCESS;
    }
